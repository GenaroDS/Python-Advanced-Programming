...
window.blit(robot, (640 - robot.get_width(), 0))  # Top-right corner
window.blit(robot, (0, 480 - robot.get_height()))  # Bottom-left corner
window.blit(robot, (640 - robot.get_width(), 480 - robot.get_height()))  # Bottom-right corner
pygame.display.flip()
